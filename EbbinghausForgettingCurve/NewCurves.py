    ...
    for i in range(len(corr_rates)):
        for j in range(len(corr_rates[i])):
            ...
            if len(new_lst) >= 5:
                ...
                new_time_list = [time_stamp_list[i] for i in kept_indices]
...
Curves_paras, my_cor_rate_x_list, my_cor_rate_y_list = Fitring_curves(my_cor_rate)
